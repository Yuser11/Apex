            ...
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form action={acaoCadastro} className="row g-3">
                    ...
                    <div className="col-md-4">
                        ...
                        <input value={cpf} onChange={(e) => setCpf(e.target.value)} type="text" className="form-control" id="cpf" name="cpf" placeholder="Digite seu CPF" required />
                    </div>
                    
                    <div className="col-md-4">
                        <label htmlFor="nascimento" className="form-label">Data de nascimento:</label>
                        <input value={nascimento} onChange={(e) => setNascimento(e.target.value)} type="date" className="form-control" id="nascimento" name="nascimento" required />
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="telefone" className="form-label">Telefone:</label>
                        <input value={telefone} onChange={(e) => setTelefone(e.target.value)} type="text" className="form-control" id="telefone" name="telefone" required />
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="modalidade" className="form-label">Modalidade:</label>
                        <input value={modalidade} onChange={(e) => setModalidade(e.target.value)} type="text" className="form-control" id="modalidade" name="modalidade" required />
                    ...
                    <div className="col-12">
                        ...
                        <input value={complemento} onChange={(e) => setComplemento(e.target.value)} type="text" className="form-control" id="complemento" name="complemento" placeholder="Apartamento..." />
                    </div>
                    <div className="col-12">
                        <label htmlFor="arquivos" className="form-label">Arquivos:</label>
                        <input value={arquivos} onChange={(e) => setArquivos(e.target.value)} type="file" className="form-control" id="arquivos" name="arquivos" placeholder="Apartamento..." />
                    </div>
